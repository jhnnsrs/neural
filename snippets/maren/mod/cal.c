	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 cal /cygdrive/d/NEURON/MODEL_Christian_AcD_ScD_Test/mod/cal.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("cal", "cannot be used with CVODE");}
