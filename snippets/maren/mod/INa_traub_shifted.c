	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 inaT /cygdrive/d/NEURON/MODEL_Christian_AcD_ScD_Test/mod/INa_traub_shifted.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("inaT", "cannot be used with CVODE");}
