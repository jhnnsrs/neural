...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 hNa /code/notebooks/x86_64/hNa.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/code/notebooks/mod/hNa.mod";
static const char* nmodl_file_text = 
  ...
  "	gbar   = 0     (mmho/cm2)  : initialize conductance to zero\n"
