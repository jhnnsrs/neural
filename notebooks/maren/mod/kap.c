	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 kap /cygdrive/d/NEURON/MODEL_Christian_AcD_ScD_Test/mod/kap.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("kap", "cannot be used with CVODE");}
